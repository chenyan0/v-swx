<template>
  <div class="container">
    <Header :title="article.post_title" isBack></Header>
    <div class="main-container">
      ...
      <div class="commentArea mgt-20">
        ...
        <div class="comment-lists">
          ...
          <div v-else class="comment-item" v-for="(item,index) in article.comments_info" :key="index">
    ...
    <div class="commentBlock">
      ...
      <div class="comment-input">
        <input type="text" ref="commentText" placeholder="评论..." v-model="commentText">
        <button :class="{'disabled':disabled}" @click="postComment">发送</button>
      </div>
      <div class="emoji">
        <font-awesome-icon :icon="['far', 'meh-blank']" class="icon" />
      </div>
    </div>
  </div>
</template>
